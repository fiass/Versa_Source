...
namespace Versa.F_Module
{
    class Popup
    {
        ...
        public static async void ShowUnityInputPopupWithCancel(string title, string TextInField, string RightButtonText, Il2CppSystem.Action<string, Il2CppSystem.Collections.Generic.List<KeyCode>, Text> action)
        {
        if (instance != null) instance.Method_Public_Void_String_String_InputType_Boolean_String_Action_3_String_List_1_KeyCode_Text_Action_String_Boolean_Action_1_VRCUiPopup_Boolean_Int32_1(
        title, TextInField, InputField.InputType.Standard, false, RightButtonText, action, new Action(() => { }));
        }
        internal static async void GoToWorld()
        {
