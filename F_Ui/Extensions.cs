...
namespace Versa.F_Ui
{
    public static class Extensions
    {
        ...
        public static WingPage CreateNestedPage(this WingPage page, string name, int index, Texture2D texture) => new WingPage(page, name, index, texture);
        public static WingPage CreateNestedPage(this WingPage page, string name, string tittle, int index, Texture2D texture) => new WingPage(page, name, tittle, index, texture);
