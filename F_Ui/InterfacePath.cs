...
namespace Versa.F_Ui
{
    internal class InterfacePath
    {
        ...
        internal static GameObject Canvas_QuickMenu = UiApi.UiManager_GameObject().transform.Find("/UserInterface/Canvas_QuickMenu(Clone)").gameObject;
